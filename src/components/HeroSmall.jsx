        ...
        <section className=' bg-[rgb(212,228,244)]   '>
            <div className='grid gap-5 w-[90%]  mx-auto  lg:grid lg:grid-cols-3 lg:justify-between  px-5  py-10 lg:py-10 md:w-[90%] md:mx-auto '>
                ...
                <Image
                    ...
                    height={50}
                />
                <span className='text-[#00296D] text-2xl w-full font-bold text-1xl flex justify-center lg:text-3xl'>Direccion</span>
            ...
            <div className='flex gap-3 items-center justify-between border  lg:gap-0  '>
                <Image
                    ...
                    className=' '
                />
                <span className=' text-2xl text-[#00296D] font-bold text-1xl w-full text-center lg:text-3xl md:text-1xl  lg:w-full'>Telefono</span>
            ...
            <div className='flex items-center justify-between lg:gap-0 ' >
                <Image
                    ...
                    className=''
                />
                <span className=' text-2xl  text-[#00296D] font-bold text-1xl w-full text-center lg:text-3xl'>Email</span>
